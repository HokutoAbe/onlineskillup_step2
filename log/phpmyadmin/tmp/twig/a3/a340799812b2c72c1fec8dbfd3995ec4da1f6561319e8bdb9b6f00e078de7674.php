...
";
    ...
    {
        return new Twig_Source("", "database/structure/favorite_anchor.twig", "/virtual/northdipper/public_html/log/phpmyadmin/templates/database/structure/favorite_anchor.twig");
    }
}
